...
* Obtain your API access token obtained from the Smartsheet Account button, under Personal settings

* Run the application using your preferred IDE or at the command line with `SMARTSHEET_ACCESS_TOKEN=<your-api-token> node node-read-write-sheet.js`
